...
const ConfigComp = ({ dict }) => {
  const [previousTotalPrice, setPreviousTotalPrice] = useState(
    initialAmbulance.totalPrice
  );
  ...
  const [generally, setGenerally] = useState(() => {
    if (typeof window !== "undefined") {
      ...
      // Sunucu tarafında çalışırken initialAmbulance'i döndür
      return initialAmbulance;
    }
  });
    ...
    const newGenerally = {
      ...
      totalPrice:
        key === "extraFeatures"
          ...
          : generally.totalPrice - generally.prices[key],
    };
